...
class MXEncoder(SMTEncoder):
    ...
    def get_literals(self, sample):
        ...
        #print("sample_internal:", sample_internal)
        #print("self.intvs:", self.intvs)
        #print("self.ivars:", self.ivars)
        #print("self.xgb.extended_feature_names_as_array_strings:", self.xgb.extended_feature_names_as_array_strings)
    ...
    def features_to_literals(self, features, sample):
      lits = []
      for feature in features:
        feat = self.xgb.extended_feature_names_as_array_strings[feature]
        fval = sample[feature]
        if feat in self.intvs:
          # determining the right interval and the corresponding variable
          for ub, fvar in zip(self.intvs[feat], self.ivars[feat]):
