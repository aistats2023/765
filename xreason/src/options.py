...
class Options(object):
    ...
    def __init__(self, command):
        ...
        # for PyLearningExplainer
        self.from_py_learning_explainer = None
        self.instance_file = None
        self.start_from_file = None
    ...
    def parse(self, command):
        ...
        try:
            opts, args = getopt.getopt(command[1:],
                                    ...
                                    ['am1', 'accmin=', 'encode=', 'cardenc=',
                                     ...
                                     'minz', 'from-py-learning-explainer=', 'instance-file=', 'start-from-file='])
        ...
        for opt, arg in opts:
            if opt in ('-1', '--am1'):
                self.am1 = True
            elif opt == '--start-from-file':
                self.start_from_file = str(arg) 
            elif opt == '--from-py-learning-explainer':
                self.from_py_learning_explainer = str(arg) 
            elif opt == '--instance-file':
                self.instance_file = str(arg) 
